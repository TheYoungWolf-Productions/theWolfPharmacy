        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header pt-1 pb-0">
                    <h4 class="card-title"><a href="addProduct" class="btn btn-primary "><i class="la la-plus"></i>Add New</a></h4>
                            ...
                            <table class="table table-striped table-bordered dom-jQuery-events">
                                ...
                                <tbody>
                                    ...
                                    foreach ($result as $value) { ?>
                                        <tr>
                                            <td>
                                                <a title="Edit" href="addProduct?id=<?= $value['id'] ?>" class="btn btn-icon btn-primary mr-1 mb-1"><i class="la la-edit"></i></a>
                                                <button type="button" class="btn btn-icon btn-danger mr-1 mb-1 cancel-button" id="<?= $value['id'] ?>" data-val="<?= $value['quantity'] ?>"><i class="la la-trash"></i></button>
                                            </td>
                                            <td><?= $i ?></td>
                                            <td><?= $value['name'] ?></td>
                                            <td><?= $value['unit'] ?></td>
