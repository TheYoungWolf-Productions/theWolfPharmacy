            ...
            <div class="navbar-header">
                <ul class="nav navbar-nav flex-row">
                    ...
                    <li class="nav-item"><a class="navbar-brand" href="index.php"><img class="brand-logo" alt="modern admin logo" src="../public/assets/uploads/settings/<?= $logo ?>">
                            <h3 class="brand-text">Administrator</h3>
                        </a></li>
    ...
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal navbar-fixed navbar-dark navbar-without-dd-arrow navbar-shadow" role="navigation" data-menu="menu-wrapper">
        <div class="navbar-container main-menu-content" data-menu="menu-container">
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="sales"><i class="la la-euro"></i><span>Sales</span></a>
                </li>
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="manufacturers"><i class="la la-tags"></i><span>Manufacturers</span></a>
                </li>
                ...
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="" data-toggle="dropdown"><i class="la la-medkit"></i><span>Reports</span></a>
                    <ul class="dropdown-menu">
                        <li data-menu=""><a class="dropdown-item" href="sales_report" data-toggle=""><i class="la la-edit"></i><span>Sales Report -</span><img src="https://img.icons8.com/color/48/fa314a/coming-soon.png" /></a>
                        </li>
                        <li data-menu=""><a class="dropdown-item" href="purchase_report" data-toggle=""><i class="la la-archive"></i><span>Purchase Report -</span><img src="https://img.icons8.com/color/48/fa314a/coming-soon.png" /></a>
                        </li>
                        <li data-menu=""><a class="dropdown-item" href="customer_report" data-toggle=""><i class="la la-group"></i><span>Customer Report -</span><img src="https://img.icons8.com/color/48/fa314a/coming-soon.png" /></a>
                        </li>
                        <li data-menu=""><a class="dropdown-item" href="purchase_report?expired=1" data-toggle=""><i class="la la-exclamation-circle"></i><span>Purchase Expiry Report -<img src="https://img.icons8.com/color/48/fa314a/coming-soon.png" /></a>
                        </li>
                    </ul>
                </li>
